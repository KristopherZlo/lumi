...
record LumiRestoreMeasurement(
    ...
    String describe() {
        return "totalMs=" + totalMillis
                ...
                + ";chunkWrites=" + apply.chunkWrites()
                + ";poiWrites=" + apply.poiWrites()
                + ";entityWrites=" + apply.entityWrites()
                + ";chunkRegions=" + apply.chunkRegions()
                + ";poiRegions=" + apply.poiRegions()
                + ";entityRegions=" + apply.entityRegions()
