...
/** Centered modal geometry with safe margins on small windows. */
public record LumiModalLayout(int x, int y, int width, int height) {
    private static final int MARGIN = 10;
    private static final int MAX_WIDTH = 320;

    public static LumiModalLayout fit(
