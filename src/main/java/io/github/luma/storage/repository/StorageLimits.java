...
final class StorageLimits {
    ...
    static final int MAX_SNAPSHOT_FRAME_COMPRESSED_BYTES = 64 * 1024 * 1024;
    static final int MAX_SNAPSHOT_FRAME_UNCOMPRESSED_BYTES = 64 * 1024 * 1024;
    ...
    static final int MAX_SNAPSHOT_PACKED_LONGS = 4096;
