...
- `WorldMutationContext`: prevents restore application from being re-captured as tracked history and can temporarily suppress capture while Lumi dispatches native external-tool undo/redo commands or Axiom native replay hooks
