...
- `CompareScreenSections` and `ProjectScreenSections` own repeated route section composition, while their screens keep route lifecycle, transient selection state, and action callbacks
