...
- `CompareScreenSections`, `ProjectScreenSections`, and focused Save details section builders own repeated route section composition, while their screens keep route lifecycle, transient selection state, and action callbacks
