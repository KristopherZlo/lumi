...
- `ProjectWindowLayout` gives the project home screen a compact LDLib2-style window frame with a sidebar, title bar, status strip, and scrollable content area while the compatible Fabric renderer remains active
