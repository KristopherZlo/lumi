...
- restore/apply budgets adapt downward when a tick slice exceeds its budget and recover gradually when slices stay cheap; native cells and rewrite-section bursts have explicit caps in addition to block count and time budgets
