...
- bounded chunk preload and chunk-batch application on the server tick through `WorldOperationManager`, including adaptive block budgets, explicit preload chunk caps, fast-profile-only synchronous chunk reacquire after preload misses, and explicit block-entity/entity caps
