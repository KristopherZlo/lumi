...
| Client update notices | `UpdateCheckService`, `UpdateWorldJoinNotifier`, `UpdatePromptCoordinator` | `HttpUpdateSource`, `UpdateSourceChain`, `UpdateCandidateSelector`, `ProjectScreen`, `UpdateNoticeDialogView`, `updates/lumi-fabric.json` | `src/test/java/io/github/luma/client/update`, `LanguageFilesTest`, `docs/user-guide.md`, `docs/development.md` |
