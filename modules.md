...
- `ChunkSectionUpdateBroadcaster`, `WorldLightUpdateQueue`, `WorldLightUpdateContext`: batched section/block-entity client update packets and operation-scoped deferred light preparation, check drains, dirty chunk marking, threaded light-engine barriers, and automatic `light-refresh` follow-up actions after block/entity replay.
