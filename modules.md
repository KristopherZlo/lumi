...
- `telemetry-backend/src/server.js`: minimal Node ingest API entry point for diagnostic telemetry, with request validation, rate limiting, retention, and Postgres storage helpers in the sibling `src/` files.
