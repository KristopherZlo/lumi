...
- `RestoreCompletionCoordinator`: publishes full and partial restore completion after prepared world apply succeeds, including pending completion records, staged partial-restore publication, variant-head/project metadata updates, undo/redo cleanup or action recording, journal entries, and capture-cache invalidation.
