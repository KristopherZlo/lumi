...
- `PatchDataRepository`, `PatchFrameCompression`, `PatchSectionFrameCodec`, `PatchPayloadMetadataBuilder`, `PatchEntityChunkIndexLookup`: `patches/*.bin.lz4` schema reads/writes, patch frame compression, section frame encoding, section fingerprint metadata, entity index construction, and selective chunk/section/entity-frame reads.
