...
- Player-caused mob and explosion block fallout is captured in recovery drafts and saved project history, and is also available to live undo/redo for immediate cleanup.
