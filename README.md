...
- Existing workspaces mark every captured block source, including growth, dirty for settled section reconciliation. This captures actionless redstone and other vanilla block fallout for recovery, save, and quick rollback without letting ordinary chunk loading open or extend a draft; actionless fallout still does not create a live undo action or workspace.
