...
- Restore, recovery, merge, quick rollback, and undo/redo replay verify final target state before reporting success. A mismatch gets one repair pass followed by a fresh read-back; a remaining mismatch fails the operation. Full restore and quick rollback are undoable with live undo.
