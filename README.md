...
| Wooden sword | Select a region; `Left Alt+MMB` resizes, `Left Alt+LMB` switches mode, `Left Alt+RMB` clears, `Left Alt+Z/Y` undo/redo selection, `Ctrl` adds/removes active-zone cells |
