...
A newer full Restore, branch switch, or workspace switch replaces only the same
player's older queued world selection. Active work and other builders are not
cancelled.
